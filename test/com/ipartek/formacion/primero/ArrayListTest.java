...
public class ArrayListTest {
	...
	public void setUp() throws Exception {
		...
		listaVehiculos.add(new Vehiculo(5, 150f));
		listaVehiculos.add(new Vehiculo(2, 50f));
		listaVehiculos.add(new Vehiculo(4, 350f));
	}
	...
	public void testCollectionSortClases() {
		...
		assertEquals(Vehiculo.MIN_POTENCIA,
				listaVehiculos.get(0).getPotencia(), DELTA);
