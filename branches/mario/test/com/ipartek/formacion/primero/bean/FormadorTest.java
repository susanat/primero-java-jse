...
public class FormadorTest {
	...
	public void testFormador() {
		...
		Formador formador = new Formador("lala", "lolo", "45454545S", 35, 1005.36f);
		...
		assertEquals( Formador.MIN_SUELDO, formVacio.getSueldo(), Float.MIN_VALUE );
		...
		assertTrue("Edad incorrecta, no es mayor de edad", formador.isMayorEdad());
