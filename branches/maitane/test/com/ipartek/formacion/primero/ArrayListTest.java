...
public class ArrayListTest {
	...
	ArrayList<String> listaPaisesDesordeanda = null;
	...
	public void setUp() throws Exception {
		...
		listaPaisesDesordeanda = new ArrayList<String>();
		listaPaisesDesordeanda.add(PORTUGAL);
		listaPaisesDesordeanda.add(EUSKADI);
		listaPaisesDesordeanda.add(ESPANA);
	...
	public void testCollectionSortPrimitivos() {
		...
		// Colections.sort nos ordena una lista

		// Ordenar alfabeticamente Strings

		Collections.sort(listaPaisesDesordeanda);
		assertSame(ESPANA, listaPaisesDesordeanda.get(0));
		assertSame(EUSKADI, listaPaisesDesordeanda.get(1));
		assertSame(PORTUGAL, listaPaisesDesordeanda.get(2));

		Collections.reverse(listaPaisesDesordeanda);
		assertSame(PORTUGAL, listaPaisesDesordeanda.get(0));
		assertSame(EUSKADI, listaPaisesDesordeanda.get(1));
		assertSame(ESPANA, listaPaisesDesordeanda.get(2));

		// Ordenar ordinalemente (de mayor a menor) ints
	...
	public void testCollectionSortClases() {
		...
		// 0f se pone para los float (o se declara ststic final float DELTA=0f).
		// Tiene que ser con assertEquals
