...
/**
 * Cambio es una clase java se encarga de calcular las vueltas a una cantidad de dinero para una factura determinada
...
public class Cambio {
	 /**
	  *Coleccion cambios es un <code>TreeMap<Double,Integer></code> ordenado a la inversa que tiene como indices los 
	  *valores de monedas y billetes como valor el numero de monedas y/o billetes que se van a devolver 
	  */
    ...
    /**
     * Inicializa el valor del Map de los cambios con los valores de monedas y billetes
     */
    public  Cambio() {
    	super();
    	iniValor();
     ...
     * @param d_entregado {@code Double} dinero entregado 
     * @param coste {@code Double} coste de la compra
     * 
     */
	public void calcularVueltas(Double d_entregado, Double coste) {

		Double dinero = 0.0;
		
		MyMath.compruebaMayor(d_entregado);
		MyMath.compruebaMayor(coste);
			
		dinero = d_entregado-coste;
