...
/*
 * TODO mirar lo de los logs: http://expertojava.ua.es/j2ee/publico/lja-2012-13/sesion06-apuntes.html	
 */
...
//////INICIO LOGICA DE LOS EVENTOS
  ...
  //////FIN LOGICA DE LOS EVENTOS  
		 ...
		 * 
		 * @param calificacion ClsCalificacion
		 */
		...
		public String toString() {
			...
			//ejecutamos el evento de mostrado (sin sentido, para guardar el código)
			onMostrado(this);
			
			return "clsAlumno [nombre=" + nombre + ", apellido1=" + apellido1
					+ ", apellido2=" + apellido2 + ", edad=" + edad + ", dni="
					+ dni + ", poblacion=" + poblacion + ", mayoredad="
					+ mayoredad + ", telefono=" + telefono + ", sexo=" + sexo
					+ "]";
		}
		    ...
		    try
		    {
		    	...
		    	objAlumno.setonListado(new onAlumno() {
					...
					public void onMostrado(ClsAlumno obj) {
						ClsUtilsUI.mensajeError("No es de error", "El alumno será mostrado");
						System.out.println("Mostrado");
					}
					
					@Override
					public void onCargado(ClsAlumno obj) {						
						ClsUtilsUI.mensajeError("No es de error", "El alumno ha sido cargado");
	...
	enum ObjetoComparator implements Comparator<ClsAlumno> {
		 ...
		 * @return
		 */
		public static Comparator<ClsAlumno> decending(final Comparator<ClsAlumno> other) {
		 ...
		 * @return
		 */
		public static Comparator<ClsAlumno> ascending(final Comparator<ClsAlumno> other) {
			return new Comparator<ClsAlumno>() {
				public int compare(ClsAlumno o1, ClsAlumno o2) {
		...
		public static Comparator<ClsAlumno> getComparator(final ObjetoComparator... multipleOptions) {
			return new Comparator<ClsAlumno>() {
				public int compare(ClsAlumno o1, ClsAlumno o2) {
