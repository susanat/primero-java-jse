...
public class Calculadora {
	...
	public static void main(String[] args) {
		 ...
		 * vueltas / 10 + " Billetes de 10"); vueltas %= 10;
		 * System.out.println("En " + (int) vueltas / 5 + " Billetes de 5");
		 * vueltas %= 5; System.out.println("En " + (int) vueltas / 2 +
		 * " Monedas de 2 Euros"); vueltas %= 2; System.out.println("En " +
		 * (int) vueltas / 1 + " Monedas de 1 Euro"); vueltas %= 1;
		 * 
