...
public class Alumno_back {
	...
	public Alumno_back(String nombre, String apellido1, String dni) {
		super();
		this.nombre = nombre;
	...
	public Alumno_back(String nombre, String apellido1, int edad, String dni) {
		super();
		this.nombre = nombre;
		this.apellido1 = apellido1;
		this.edad = edad;
