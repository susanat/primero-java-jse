...
/**
 * La clase MyMath es una clase destinada a suplir las carencias de Java 1.6 en
 * temas matematicos
 * 
...
public class MyMath {
	 ...
	 *
	 * @param valor
	 *            {@code double} es el valor a redondear
	 * @param lugar
	 *            {@code int} es el numero de decimales que queramos
	 ...
	 * 
	 * @param numero
	 *            {@code Double} numero enviado
	 */
	public static void compruebaMayor(Double numero) {
		if (numero <= 0)
			throw new IllegalArgumentException(
					"No se adminten numeros negativos");
	}
}
